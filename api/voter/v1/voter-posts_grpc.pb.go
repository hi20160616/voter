...
func (c *postsAPIClient) DeletePost(ctx context.Context, in *DeletePostRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (UnimplementedPostsAPIServer) DeletePost(context.Context, *DeletePostRequest) (*empty.Empty, error) {
