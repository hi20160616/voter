...
func (c *ipVotesAPIClient) DeleteIpVote(ctx context.Context, in *DeleteIpVoteRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (UnimplementedIpVotesAPIServer) DeleteIpVote(context.Context, *DeleteIpVoteRequest) (*empty.Empty, error) {
