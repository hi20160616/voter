...
func (c *votesAPIClient) DeleteVote(ctx context.Context, in *DeleteVoteRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (UnimplementedVotesAPIServer) DeleteVote(context.Context, *DeleteVoteRequest) (*empty.Empty, error) {
